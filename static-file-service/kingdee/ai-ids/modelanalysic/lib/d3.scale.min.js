...
!(function (n, t) {
  ...
  function f() {
    ...
    function m() {
      var e = u().length,
        ...
        l = o ? c : a,
        f = o ? a : c
      ;(n = (f - l) / Math.max(1, e - p + 2 * h)),
        s && (n = Math.floor(n)),
        (l += (f - l - n * (e - p)) * g),
        (r = n * (1 - p)),
        s && ((l = Math.round(l)), (r = Math.round(r)))
  ...
  function d(n, t, r) {
    var e = n[0],
      ...
      o = t[1]
    return (
      u < e ? ((e = m(u, e)), (i = r(o, i))) : ((e = m(e, u)), (i = r(i, o))),
      function (n) {
        return i(e(n))
      }
    )
  ...
  function y(n, r, e) {
    var u = Math.min(n.length, r.length) - 1,
      ...
      a = -1
    for (
      n[u] < n[0] && ((n = n.slice().reverse()), (r = r.slice().reverse()));
      ++a < u;

    )
      (i[a] = m(n[a], n[a + 1])), (o[a] = e(r[a], r[a + 1]))
    return function (r) {
  ...
  function w(n, r, u, i) {
    ...
    switch ((i = e.formatSpecifier(null == i ? ',f' : i)).type) {
      ...
      case 'r':
        null != i.precision ||
          isNaN(
            (o = e.precisionRound(a, Math.max(Math.abs(n), Math.abs(r)))),
          ) ||
    ...
    return (
      ...
      (n.nice = function (e) {
        ...
        var u,
          ...
          s = 10
        for (
          f < l && ((i = l), (l = f), (f = i), (i = a), (a = c), (c = i));
          s-- > 0;

        ) {
          if ((i = t.tickIncrement(l, f, e)) === u)
            return (o[a] = l), (o[c] = f), r(o)
          if (i > 0) (l = Math.floor(l / i) * i), (f = Math.ceil(f / i) * i)
          else {
            if (!(i < 0)) break
    ...
    return (
      ...
      (r.tickFormat = (n, t) => {
        if (
          ...
          'function' != typeof t &&
            (a % 1 ||
              null != (t = e.formatSpecifier(t)).precision ||
              (t.trim = !0),
            (t = e.format(t))),
          n === 1 / 0)
        )
  ...
  function Q(n) {
    var t = n(g, g),
      r = 1
    function e() {
      return 1 === r ? n(g, g) : 0.5 === r ? n(E, L) : n(P(r), P(1 / r))
    }
    return (
  ...
  function W() {
    ...
    function f(t) {
      return null == t || isNaN((t = +t))
        ...
        : c(
            0 === e
              ? 0.5
              : ((t = (u(t) - n) * e), l ? Math.max(0, Math.min(1, t)) : t),
          )
    }
    function s(n) {
      return function (t) {
    ...
    return (
      ...
      (f.range = s(r.interpolate)),
      (f.rangeRound = s(r.interpolateRound)),
      (f.unknown = function (n) {
        return arguments.length ? ((i = n), f) : i
      }),
      function (r) {
        return (
          (u = r), (n = r(o)), (t = r(a)), (e = n === t ? 0 : 1 / (t - n)), f
        )
      }
    )
  }
  ...
  function G() {
    ...
    function m(n) {
      return isNaN((n = +n))
        ? a
        : ((n = 0.5 + ((n = +o(n)) - t) * (s * n < s * t ? u : i)),
          p(h ? Math.max(0, Math.min(1, n)) : n))
    }
    function d(n) {
      return function (t) {
        var e, u, i
        return arguments.length
          ? (([e, u, i] = t), (p = r.piecewise(n, [e, u, i])), m)
          : [p(0), p(0.5), p(1)]
      }
    }
    return (
  ...
  ;(n.scaleBand = f),
    ...
    (n.scaleRadial = function n() {
      ...
      return (
        ...
        (i.range = function (n) {
          return arguments.length
            ? (r.range((e = Array.from(n, p)).map(Y)), i)
            : e.slice()
        }),
    ...
    (n.scaleSequentialSqrt = function () {
      return z.apply(null, arguments).exponent(0.5)
    }),
