 ...
 */
(function (KDApi) {
  function PredictSidebarComponent (model) {
    this._setModel(model)
  }

  PredictSidebarComponent.prototype = {
    ...
    KDApi.loadFile(cssFilePath, model, function() {
      ...
      if (window.Vue) {
        KDApi.loadFile(jsFilePath2, model, function() {
          ...
          let entryObj = predict.PredictSidebarEntry()
  ...
  // 注册自定义组件
  KDApi.register('predictsidebar', PredictSidebarComponent, {
    isMulLang: false
  })
})(window.KDApi)
