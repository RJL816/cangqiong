 ...
 */
(function (KDApi) {
  function ForecastResultComponent (model) {
    this._setModel(model)
  }

  ForecastResultComponent.prototype = {
    ...
    KDApi.loadFile(cssFilePath, model, function() {
      ...
      if (window.Vue) {
        KDApi.loadFile(jsFilePath2, model, function() {
          ...
          let entryObj = forecast.forecastResultEntry()
  ...
  // 注册自定义组件
  KDApi.register('gptforecastresult', ForecastResultComponent, {
    isMulLang: false
  })
})(window.KDApi)
