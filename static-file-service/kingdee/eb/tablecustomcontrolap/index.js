(function (KDApi, $) {
  ...
  //构造函数
  function TablecustomcontrolapComponent(model) {
    this._setModel(model)
  }
  TablecustomcontrolapComponent.prototype = {
    //绑定model
  ...
  var setHtml = function (model, props) {
    ...
    cssPathStringArray.push('css/tablecustomcontrolap_css.css');
    ...
    function afterLoadCssCallBackMethod() {
      ...
      //封装的一些工具类
      jsPathStringArray.push('lib/dev/common/2.0.0/common_utils.js');
      //VUE
    ...
    //调用业务逻辑方法
    function initMethod() {
      logicMethod(model, props, componentMap);
    }
  }
  ...
  //注册自定义控件
  KDApi.register('tablecustomcontrolap', TablecustomcontrolapComponent, {
    isMulLang: true
  })
})(window.KDApi, jQuery)