        ...
        render: function (container) {
            ...
            if (container) {
                ...
                var html = ( ie && browser.version < 9  ? '' : '<!DOCTYPE html>') +
					...
					'.invchangeformulatext{background:url(./kingdee/bcm/invchangeformulatext/themes/default/images/open.png) no-repeat 0 0;background-position-x:right;cursor: pointer;border-top:none;border-left:none;border-right:none;border-color:black;border-width:1px;outline:none;font-size:12px;height:18px;text-align:center;}' +
                    //设置段落间距
...
UE.Editor.defaultOptions = function(editor){
	editor.options.UEDITOR_HOME_URL ='kingdee/bcm/invchangeformulatext/';
...
(function () {
     ...
     *
     */
    UE.getEditor = function (id, opt,model) {		
