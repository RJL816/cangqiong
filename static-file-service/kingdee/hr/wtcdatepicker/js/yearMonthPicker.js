...
(function () {
    ...
    YearMonthPicker.prototype.yearPicker = function (year, $parentEle, callback) {
        ...
        function init(checkedYear, $this) {
            ...
            for (var i = checkedYear - 7; i <= checkedYear + 7; i++) {
                arrYear.push(i);
            }
            for (var _i = 0; _i < arrYear.length; _i++) {
                if (_i === 7) {
                    str += '<div class="wtc_datepicker-year-item wtc_datepicker-year-item-active">' + arrYear[_i] + '</div>';
                } else {
                    str += '<div class="wtc_datepicker-year-item">' + arrYear[_i] + '</div>';
                }
            }
    ...
    YearMonthPicker.prototype.monthPicker = function (year, month, $parentEle, callback) {
        ...
        $dom_monthItem.on('click', function () {
            ...
            $dom_monthWrap.css('display', 'none');
            var monthIndex = Number($(this).attr('month'));
