    ...
    MyTool.prototype.showPopover = function (data) {
        ...
        setTimeout(function () {
            ...
            if (data.target) {  // 按目标元素形式
                if (targetRect.left + dom_temp.scrollWidth > clientWidth && targetRect.bottom + dom_temp.scrollHeight > clientHeight) {  //右下角
                ...
                } else if (targetRect.left + dom_temp.scrollWidth > clientWidth && targetRect.bottom + dom_temp.scrollHeight <= clientHeight) {  // 右上角
                    dom_temp.style.left = targetRect.right - dom_temp.scrollWidth + 'px';
                ...
                } else if (targetRect.left + dom_temp.scrollWidth <= clientWidth && targetRect.bottom + dom_temp.scrollHeight > clientHeight) { // 左下角
                ...
                if (data.positionX + dom_temp.scrollWidth > clientWidth && data.positionY + dom_temp.scrollHeight > clientHeight) {  //右下角
                ...
                } else if (data.positionX + dom_temp.scrollWidth > clientWidth && data.positionY + dom_temp.scrollHeight <= clientHeight) {  // 右上角
                    dom_temp.style.left = data.positionX - dom_temp.scrollWidth + 'px';
                ...
                } else if (data.positionX + dom_temp.scrollWidth <= clientWidth && data.positionY + dom_temp.scrollHeight > clientHeight) { // 左下角
