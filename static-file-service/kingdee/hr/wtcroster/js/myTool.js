    ...
    MyTool.prototype.rightClickMenu = function (data) {
        ...
        var _loop = function _loop(i) {
            ...
            dom_menuItem[i].onmousedown = function (e) {
                ...
                var disabled = dom_menuItem[i].getAttribute('disabled');
                var hasChildren = this.querySelector('.wtc_kztTool_rightClickMenu-group');
                // 当点击的是非禁用按钮，同时没有子菜单时：
        ...
        setTimeout(function () {
            ...
            switch (popoverDirection) {
                ...
                case 'right top':
                    ...
                    if (data.showTriangle) {
                        dom_temp.style.left = data.target ? targetRect.right - dom_temp.scrollWidth + 20 + 'px' : data.positionX - dom_temp.scrollWidth + 20 + 'px';
                        var _dom_triangle4 = document.querySelector('.wtc_kztTool_tips-triangle-top-right');
                ...
                case 'left bottom':
                    ...
                    if (data.showTriangle) {
                        dom_temp.style.left = data.target ? targetRect.left - 20 + 'px' : data.positionX - 20 + 'px';
                        var _dom_triangle5 = document.querySelector('.wtc_kztTool_tips-triangle-bottom-left');
                ...
                case 'left top':
                    ...
                    if (data.showTriangle) {
                        dom_temp.style.left = data.target ? targetRect.left - 20 + 'px' : data.positionX - 20 + 'px';
                        var _dom_triangle6 = document.querySelector('.wtc_kztTool_tips-triangle-top-left');
