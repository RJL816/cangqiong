...
(function () {
    ...
    * */
    MyTool.prototype.message = function (data) {
        ...
        dom_temp.style.cssText = 'position: fixed;display: flex;top: -50px;left: 50%;transform: translateX(-50%);z-index: 9999;min-width: 200px;padding: 14px 20px;border-radius: 6px;background-color: ' + background + ';opacity: 0;animation: showMessage 0.3s;animation-fill-mode: forwards;';
