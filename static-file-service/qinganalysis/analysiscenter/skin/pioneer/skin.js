(function()
{
	...
	NS.MyIcons = new (function()
	{
		...
		{
			oIconsFile.setFilePath("analysiscenter/skin/pioneer/res/analysiscenter-sprite.png");
			oIconsFile.setGap(1);
			...
			oIconsFile.setGap(0);
			oIconsFile.setFilePath("common/skin/pioneer/res/icon-empty-error-display/icon_empty_background.png");
