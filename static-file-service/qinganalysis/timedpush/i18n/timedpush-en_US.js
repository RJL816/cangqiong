(function()
{
	...
	oManager.registPackageResources(oPackage, 
	{
		...
		cornInCheckOrError: "The cron expression is incorrect or the cron expression is parsing for verification.",
		...
		datacenterHelpIconTips: "Specifies the display name of the datacenter when switching the datacenter in the Light Analysis Mobile Light application ",
		...
		appIdHelpTips: "Mobile office platform ID issued by light analysis product R & D team. Please refer to the configuration document for details",
		...
		downloadThirdpartyConfigFile: "Click to download the configuration document of light analysis integrated mobile office platform",
