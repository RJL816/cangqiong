function setElement(accessuserid, employeeid, signature, initpage, appid, endorsementID, token,callback, FlightSearchType,Ddate,Adate,DCityCode,ACityCode,DCityId,ACityId,IsOversea,corpPayType,CityID,CheckInDate,CheckOutDate,Language) {
	...
	var DCityId_ = document.getElementById("DCityId");
	var ACityId_ = document.getElementById("ACityId");
	...
	DCityId_.setAttribute("value", DCityId);
	ACityId_.setAttribute("value", ACityId);
