function setElement(AppKey, Ticket, EmployeeID, Signature, TA ,SearchType,CorpPayType,From,To,FromCityId,ToCityId,DDate,CurrentLang,loginmode,Backurl) {
	...
	if(1 == loginmode) {
		...
		var FromCityId_ = document.getElementById("FromCityId");
		var ToCityId_ = document.getElementById("ToCityId");
		...
		FromCityId_.setAttribute("value", FromCityId);
		ToCityId_.setAttribute("value", ToCityId);
	}else{
...
setElement(getUrlParam("AppKey"), getUrlParam("Ticket"), getUrlParam("EmployeeID"), getUrlParam("Signature"), getUrlParam("TA"), getUrlParam("SearchType"), getUrlParam("CorpPayType"), getUrlParam("From"), getUrlParam("To"), getUrlParam("FromCityId"), getUrlParam("ToCityId"), getUrlParam("DDate"), getUrlParam("CurrentLang"), getUrlParam("loginmode"), getUrlParam("Backurl"));
