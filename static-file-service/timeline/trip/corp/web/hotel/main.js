function setElement(AppKey, Ticket, EmployeeID, Signature, TA ,SearchType,CorpPayType,CityID,CheckInDate,CheckOutDate,RoomNumber,CurrentLang,loginmode,initPage) {
...
setElement(getUrlParam("AppKey"), getUrlParam("Ticket"), getUrlParam("EmployeeID"), getUrlParam("Signature"), getUrlParam("TA"), getUrlParam("SearchType"), getUrlParam("CorpPayType"), getUrlParam("CityID"), getUrlParam("CheckInDate"), getUrlParam("CheckOutDate"), getUrlParam("RoomNumber"),getUrlParam("CurrentLang"),getUrlParam("loginmode"),getUrlParam("Backurl"));
